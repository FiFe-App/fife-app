        ...
        <View style={[{flex:1},style]}>
            <Row style={{flex:1}}>
                ...
                <View style={{flexGrow:1}}>
                    ...
                    <TextInput style={{flex:1,margin:5,marginBottom:0,padding:10,backgroundColor:'#ffffff'}} multiline rows={1} value={category} onChangeText={setCategory} 
                    placeholder={"Kategória: Cipő"}/>
                    <TextInput style={{flex:4,margin:5,marginBottom:0,padding:10,backgroundColor:'#ffffff'}} multiline rows={5} value={text} onChangeText={setText} 
