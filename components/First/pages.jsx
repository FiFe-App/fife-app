...
import { Auto, B, Col, TextInput, MyText } from '../Components';
            ...
            <ScrollView >
              ...
              <Auto key="Auto">
                <View style={{flex:2}}>
                  ...
                  <MyText style={styles.text}>Az alkalmazás célja a FiFe szellemiség megvalósítása az online térben,
                  ...
                  <Pressable style={{margin :20}} onPress={()=>setMoreOpen(true)}>
                    <MyText style={styles.link}>Olvasd tovább a rendkívül naiv és optimista képzelgéseimet 
                    <Icon name="arrow-forward-outline" size={20}/></MyText>
                  </Pressable>
                  {moreOpen && 
