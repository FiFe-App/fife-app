        ...
        <SafeAreaView style={localStyles.container}>
            <View style={localStyles.container}>
                <View style={localStyles.navbar}>
                    ...
                    <Pressable style={localStyles.barButton} onPress={() => setFilter("frien")} ><Text>Barát programok</Text></Pressable>
                </View>
                ...
                <FAB color="#f7316a" color2="rgba(255,175,0,0.7)" icon='add' size={60} onPress={()=>{navigation.push('new-event')}}/>
