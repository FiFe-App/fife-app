...
const Forgot = () => {
    ...
    return (
        <View style={{flex:1,justifyContent:'center',alignItems:'center',backgroundColor:'#fdf8de'}}>
            <View style={{width:'50%',minWidth:300,backgroundColor:'#fff',padding:8}}>
                <MyText style={{textAlign:'center'}}>Elfelejtett jelszó</MyText>
                <MyText>Semmi gond, mindenkivel előfordul!</MyText>
                <View style={{flexDirection:'row'}}>
                    <TextInput onChangeText={setEmail} style={{width:300,flex:1,padding:8,backgroundColor:'#fdf1b9'}} 
            ...
            <MyText style={{textAlign:'center'}}>{response}</MyText>
        </View>
    )
}
