...
const TermsAndServices = () => {
    return (<>
                ...
                <MyText style={{fontSize:17,marginTop:32}}>2. Use License</MyText>
                ...
                <MyText style={{fontSize:17,marginTop:32}}>3. Disclaimer</MyText>
                ...
                <MyText style={{fontSize:17,marginTop:32}}>4. Limitations</MyText>
                ...
                <MyText style={{fontSize:17,marginTop:32}}>5. Revisions and Errata</MyText>
                ...
                <MyText style={{fontSize:17,marginTop:32}}>6. Links</MyText>
                ...
                <MyText style={{fontSize:17,marginTop:32}}>7. Site Terms of Use Modifications</MyText>
                ...
                <MyText style={{fontSize:17,marginTop:32}}>8. Your Privacy</MyText>

                <MyText>Please read our Privacy Policy.</MyText>

                <MyText style={{fontSize:17,marginTop:32}}>9. Governing Law</MyText>
