    ...
    <View>
        <ScrollView contentContainerStyle={{flex:1,justifyContent:'center',alignItems:'center',backgroundColor:'#fdf8de'}}>
            <View style={{width:'70%',minWidth:500,margin:50,backgroundColor:'#fff',paddingVertical:8,paddingHorizontal:50}}>
                ...
                <MyText style={{fontSize:20,marginTop:32}}>Consent</MyText>
        
                <MyText>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</MyText>
        
                <MyText style={{fontSize:20,marginTop:32}}>Information we collect</MyText>
                ...
                <MyText style={{fontSize:20,marginTop:32}}>How we use your information</MyText>
                ...
                <MyText style={{fontSize:20,marginTop:32}}>Log Files</MyText>
                ...
                <MyText style={{fontSize:20,marginTop:32}}>Cookies and Web Beacons</MyText>
                ...
                <MyText style={{fontSize:20,marginTop:32}}>Advertising Partners Privacy Policies</MyText>
                ...
                <MyText style={{fontSize:20,marginTop:32}}>Third Party Privacy Policies</MyText>
                ...
                <MyText style={{fontSize:20,marginTop:32}}>CCPA Privacy Rights (Do Not Sell My Personal Information)</MyText>
                ...
                <MyText style={{fontSize:20,marginTop:32}}>GDPR Data Protection Rights</MyText>
                ...
                <MyText style={{fontSize:20,marginTop:32}}>Children's Information</MyText>
